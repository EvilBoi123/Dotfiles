...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    //echo $_POST['type']; 
    //echo "<br>" . $type; 
    $sqlInsert =  "INSERT INTO Requested (ID_user, Username, Type, Date_begin, End_date, Notes, status) VALUES ('" . $_SESSION['id'] . "', '" . $_SESSION['username'] . "', '" . $type . "', '" . $_POST['date'] . "', '" . $_POST['end_date'] . "', '" . $_POST['notes'] . "', 0);";
    echo $sqlInsert; 
...
<div class="container">
  <form id='submit_data' method="POST" onsubmit='return validateForm()'>
    ...
    <br>
    <input type='text' id='otherType' name='otherType' style="display:none;" placeholder='Enter other option'>
    <label for="date">Tarikh Pinjaman:</label><br>
    <input type="date" id="date" name="date"><br>
    <label for="end_date">Tarikh Pemulangan:</label><br>
    <input type="date" id="end_date" name="end_date"><br>
    <label for="notes">Tujuan Peminjaman:</label><br>
